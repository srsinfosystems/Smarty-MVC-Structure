 ...
 */ (function (d) {
    d.widget("ui.draggable", d.ui.mouse, {
        ...
        _setContainment: function () {
            ...
            if (!/^(document|window|parent)jQuery/.test(a.containment) && a.containment.constructor != Array) {
                a = d(a.containment);
                var b = a[0];
                if (b) {
                    a.offset();
 ...
 */ (function (e) {
            ...
            this._renderAxis = function (h) {
                ...
                for (var i in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        ...
                        j = ["padding", /ne|nw|n/.test(i) ? "Top" : /se|sw|s/.test(i) ? "Bottom" : /^ejQuery/.test(i) ? "Right" : "Left"].join("");
                        h.css(j, l);
                        this._proportionallyResize()
                    }
                    e(this.handles[i])
    ...
    e.ui.plugin.add("resizable", "grid", {
        resize: function () {
            ...
            if (/^(se|s|e)jQuery/.test(g)) {
                b.size.width = d.width + h;
                b.size.height = d.height + a
            } else if (/^(ne)jQuery/.test(g)) {
                b.size.width = d.width + h;
                b.size.height = d.height + a;
    ...
    e.widget("ui.selectable", e.ui.mouse, {
        ...
        _mouseStart: function (c) {
            ...
            if (!this.options.disabled) {
                ...
                this.selectees.filter(".ui-selected").each(function () {
                    ...
                    if (!c.metaKey) {
                        b.jQueryelement.removeClass("ui-selected");
                        b.selected = false;
                        b.jQueryelement.addClass("ui-unselecting");
                        b.unselecting = true;
                ...
                e(c.target).parents().andSelf().each(function () {
                    var b = e.data(this, "selectable-item");
                    if (b) {
                        var g = !c.metaKey || !b.jQueryelement.hasClass("ui-selected");
                        b.jQueryelement.removeClass(g ? "ui-unselecting" : "ui-selected").addClass(g ? "ui-selecting" : "ui-unselecting");
                        b.unselecting = !g;
                        b.selecting = g;
            ...
            if (!this.options.disabled) {
                ...
                this.selectees.each(function () {
                    ...
                    if (!(!a || a.element == f.element[0])) {
                        ...
                        if (k) {
                            if (a.selected) {
                                a.jQueryelement.removeClass("ui-selected");
                                a.selected = false
                            }
                            if (a.unselecting) {
                                a.jQueryelement.removeClass("ui-unselecting");
                                a.unselecting = false
                            }
                            if (!a.selecting) {
                                a.jQueryelement.addClass("ui-selecting");
                                a.selecting = true;
                            ...
                            if (a.selecting) if (c.metaKey && a.startselected) {
                                a.jQueryelement.removeClass("ui-selecting");
                                a.selecting = false;
                                a.jQueryelement.addClass("ui-selected");
                                a.selected = true
                            } else {
                                a.jQueryelement.removeClass("ui-selecting");
                                a.selecting = false;
                                if (a.startselected) {
                                    a.jQueryelement.addClass("ui-unselecting");
                                    a.unselecting = true
                                }
                                f._trigger("unselecting", c, {
        ...
        _mouseStop: function (c) {
            ...
            e(".ui-unselecting", this.element[0]).each(function () {
                ...
                d.jQueryelement.removeClass("ui-unselecting");
                d.unselecting = false;
            ...
            e(".ui-selecting", this.element[0]).each(function () {
                var d = e.data(this, "selectable-item");
                d.jQueryelement.removeClass("ui-selecting").addClass("ui-selected");
                d.selecting = false;
                d.selected = true;
 ...
 */ (function (d) {
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        _setContainment: function () {
            ...
            if (!/^(document|window|parent)jQuery/.test(a.containment)) {
            ...
            slide: function (a, b) {
                ...
                if (a.toHide.size()) if (a.toShow.size()) {
                    ...
                    c.each(["height", "paddingTop", "paddingBottom"], function (j, i) {
                        g[i] = "hide";
                        j = ("" + c.css(a.toShow[0], i)).match(/^([\d+-.]+)(.*)jQuery/);
                        f[i] = {
                            value: j[1],
                            unit: j[2] || "px"
                        }
 ...
 */ (function (c, l) {
    ...
    c.widget("ui.dialog", {
        ...
        moveToTop: function (a, b) {
            ...
            if (d.overlay) {
                c.ui.dialog.maxZ += 1;
                d.overlay.jQueryel.css("z-index", c.ui.dialog.overlay.maxZ = c.ui.dialog.maxZ)
            }
            a = {
 ...
 */ (function (d, p) {
    ...
    d.widget("ui.tabs", {
        ...
        _tabify: function (b) {
            ...
            this.anchors.each(function (g, f) {
                ...
                if (h.test(i)) a.panels = a.panels.add(a.element.find(a._sanitizeSelector(i)));
                    ...
                    d.data(f, "load.tabs", i.replace(/#.*jQuery/, ""));
                    i = a._tabId(f);
                    f.href = "#" + i;
                    f = a.element.find("#" + i);
                    if (!f.length) {
        ...
        _getIndex: function (b) {
            if (typeof b == "string") b = this.anchors.index(this.anchors.filter("[hrefjQuery=" + b + "]"));
            return b
        },
        destroy: function () {
            var b = this.options;
 ...
 */ (function (d, C) {
    ...
    d.extend(M.prototype, {
        ...
        _newInst: function (a, b) {
            return {
                id: a[0].id.replace(/([^A-Za-z0-9_-])/g, "\\\\jQuery1"),
                input: a,
                selectedDay: 0,
                selectedMonth: 0,
                selectedYear: 0,
...
(function (jQuery, window, document) {
    ...
    _oExt.oPagination = {
        two_button: {
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                jQuery(nPrevious).bind("click.DT", function () {
                    if (oSettings.oApi._fnPageChange(oSettings, "previous")) {
                        fnCallbackDraw(oSettings)
                    }
                });
                jQuery(nNext).bind("click.DT", function () {
                    if (oSettings.oApi._fnPageChange(oSettings, "next")) {
                        fnCallbackDraw(oSettings)
                    }
                });
                jQuery(nPrevious).bind("selectstart.DT", function () {
                    return false
                });
                jQuery(nNext).bind("selectstart.DT", function () {
                    return false
                });
        ...
        full_numbers: {
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                jQuery(nFirst).bind("click.DT", function () {
                ...
                jQuery(nLast).bind("click.DT", function () {
                    if (oSettings.oApi._fnPageChange(oSettings, "last")) {
                        fnCallbackDraw(oSettings)
                    }
                });
                jQuery("span", nPaging).bind("mousedown.DT", function () {
                    return false
            ...
            fnUpdate: function (oSettings, fnCallbackDraw) {
                ...
                for (i = 0, iLen = an.length; i < iLen; i++) {
                    ...
                    jQuery("span", qjPaginateList).bind("click.DT", fnClick).bind("mousedown.DT", fnFalse).bind("selectstart.DT", fnFalse);
    ...
    jQuery.fn.dataTable = function (oInit) {
        ...
        this.fnUpdate = function (mData, mRow, iColumn, bRedraw, bAction) {
            ...
            var iRow = (typeof mRow == "object") ? _fnNodeToDataIndex(oSettings, mRow) : mRow;
            if (jQuery.isArray(mData) && typeof mData == "object") {
        ...
        this.fnDestroy = function () {
            ...
            if (!oSettings.bJUI) {
                jQuery("th", oSettings.nTHead).removeClass([_oExt.oStdClasses.sSortable, _oExt.oStdClasses.sSortableAsc, _oExt.oStdClasses.sSortableDesc, _oExt.oStdClasses.sSortableNone].join(" "))
            } else {
                jQuery("th", oSettings.nTHead).removeClass([_oExt.oStdClasses.sSortable, _oExt.oJUIClasses.sSortableAsc, _oExt.oJUIClasses.sSortableDesc, _oExt.oJUIClasses.sSortableNone].join(" "));
                jQuery("th span." + _oExt.oJUIClasses.sSortIcon, oSettings.nTHead).remove();
                jQuery("th", oSettings.nTHead).each(function () {
                    var jqWrapper = jQuery("div." + _oExt.oJUIClasses.sSortJUIWrapper, this);
        ...
        function _fnAddData(oSettings, aDataSupplied) {
            var oCol;
            var aDataIn = (typeof aDataSupplied.length == "number") ? aDataSupplied.slice() : jQuery.extend(true, {}, aDataSupplied);
        ...
        function _fnCreateTr(oSettings, iRow) {
            ...
            if (oData.nTr === null) {
                ...
                if (typeof oData._aData.DT_RowClass != "undefined") {
                    jQuery(oData.nTr).addClass(oData._aData.DT_RowClass)
                }
                for (var i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                ...
                for (i = 0, iLen = nTrs.length; i < iLen; i++) {
                    if (nTrs[i].nodeName.toUpperCase() == "TR") {
                        ...
                        for (j = 0, jLen = nTds.length; j < jLen; j++) {
                            ...
                            if (sNodeName == "TD" || sNodeName == "TH") {
                                _fnSetCellData(oSettings, iThisIndex, jInner, jQuery.trim(nTds[j].innerHTML));
                                jInner++
                            }
                        }
                    }
        ...
        function _fnBuildHead(oSettings) {
            ...
            if (oSettings.oFeatures.bSort) {
                for (i = 0; i < oSettings.aoColumns.length; i++) {
                    if (oSettings.aoColumns[i].bSortable !== false) {
                        ...
                        jQuery(oSettings.aoColumns[i].nTh).bind("mousedown.DT", fnNoSelect)
                    } else {
            ...
            if (oSettings.oClasses.sFooterTH !== "") {
                jQuery(">tr>th", oSettings.nTFoot).addClass(oSettings.oClasses.sFooterTH)
            }
        ...
        function _fnDraw(oSettings) {
            ...
            if (typeof oSettings.fnHeaderCallback == "function") {
                oSettings.fnHeaderCallback.call(oSettings.oInstance, jQuery(">tr", oSettings.nTHead)[0], _fnGetDataMaster(oSettings), oSettings._iDisplayStart, oSettings.fnDisplayEnd(), oSettings.aiDisplay)
            }
            if (typeof oSettings.fnFooterCallback == "function") {
                oSettings.fnFooterCallback.call(oSettings.oInstance, jQuery(">tr", oSettings.nTFoot)[0], _fnGetDataMaster(oSettings), oSettings._iDisplayStart, oSettings.fnDisplayEnd(), oSettings.aiDisplay)
            }
            ...
            if (oSettings.oScroll.bInfinite) {
                jQuery(nScrollBody).scroll(function () {
                    if (!oSettings.bDrawing) {
                        if (jQuery(this).scrollTop() + jQuery(this).height() > jQuery(oSettings.nTable).height() - oSettings.oScroll.iLoadGap) {
        ...
        function _fnScrollDraw(o) {
            ...
            if (o.oScroll.sX === "") {
                ...
                if (o.oScroll.sXInner !== "") {
                    ...
                    if (iSanityWidth == jQuery(nScrollBody).width() && jQuery(nScrollBody).height() < jQuery(o.nTable).height()) {
        ...
        function _fnSortAttachListener(oSettings, nNode, iDataIndex, fnCallback) {
            jQuery(nNode).bind("click.DT", function (e) {
        ...
        function _fnSortingClasses(oSettings) {
            ...
            if (oSettings.oFeatures.bSort && oSettings.oFeatures.bSortClasses) {
                ...
                if (oSettings.oFeatures.bDeferRender) {
                    jQuery(nTds).removeClass(sClass + "1 " + sClass + "2 " + sClass + "3")
                } else {
                    if (nTds.length >= iColumns) {
                        for (i = 0; i < iColumns; i++) {
                            if (nTds[i].className.indexOf(sClass + "1") != -1) {
                                for (j = 0, jLen = (nTds.length / iColumns); j < jLen; j++) {
                                    nTds[(iColumns * j) + i].className = jQuery.trim(nTds[(iColumns * j) + i].className.replace(sClass + "1", ""))
                                }
                            } else {
                                if (nTds[i].className.indexOf(sClass + "2") != -1) {
                                    for (j = 0, jLen = (nTds.length / iColumns); j < jLen; j++) {
                                        nTds[(iColumns * j) + i].className = jQuery.trim(nTds[(iColumns * j) + i].className.replace(sClass + "2", ""))
                                    }
                                } else {
                                    if (nTds[i].className.indexOf(sClass + "3") != -1) {
                                        for (j = 0, jLen = (nTds.length / iColumns); j < jLen; j++) {
                                            nTds[(iColumns * j) + i].className = jQuery.trim(nTds[(iColumns * j) + i].className.replace(" " + sClass + "3", ""))
                                        }
                                    }
                                }
                            }
                    ...
                    for (i = 0; i < oSettings.aoColumns.length; i++) {
                        if (oSettings.aoColumns[i].bVisible) {
                            if (oSettings.aoColumns[i].sWidthOrig === null) {
                                ...
                                iTotal += parseInt(oSettings.aoColumns[i].sWidth.replace("px", ""), 10) + (jQuery(oNodes[iCorrector]).outerWidth() - jQuery(oNodes[iCorrector]).width())
                            }
                            iCorrector++
                        }
                    }
        ...
        function _fnLoadState(oSettings, oInit) {
            ...
            if (sData !== null && sData !== "") {
                try {
                    oData = (typeof jQuery.parseJSON == "function") ? jQuery.parseJSON(sData.replace(/'/g, '"')) : eval("(" + sData + ")")
                } catch (e) {
                    return
                }
        ...
        function _fnCreateCookie(sName, sValue, iSecs, sBaseName, fnCallback) {
            ...
            if (fnCallback !== null) {
                oData = (typeof jQuery.parseJSON == "function") ? jQuery.parseJSON(sValue) : eval("(" + sValue + ")");
        ...
        return this.each(function () {
                            ...
                            if (typeof aTargets[j] == "number" && aTargets[j] < 0) {
                                ...
                                if (typeof aTargets[j] == "string") {
                                    for (k = 0, kLen = oSettings.aoColumns.length; k < kLen; k++) {
                                        if (aTargets[j] == "_all" || jQuery(oSettings.aoColumns[k].nTh).hasClass(aTargets[j])) {
            ...
            _fnSortingClasses(oSettings);
            var thead = jQuery(">thead", this);
            if (thead.length === 0) {
                thead = [document.createElement("thead")];
                this.appendChild(thead[0])
            }
            oSettings.nTHead = thead[0];
            var tbody = jQuery(">tbody", this);
            if (tbody.length === 0) {
                tbody = [document.createElement("tbody")];
                this.appendChild(tbody[0])
            }
            oSettings.nTBody = tbody[0];
            var tfoot = jQuery(">tfoot", this);
            if (tfoot.length > 0) {
 ...
 */ (function (i, wa, p) {
    ...
    i.fn.dataTable = function (g) {
        ...
        function oa(a) {
            return a.replace(new RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\jQuery|\\^)", "g"), "\\jQuery1")
        }
        function ra(a, b) {
        ...
        this.fnDestroy = function () {
            ...
            a.aaSortingFixed = [];
            T(a);
            i(jQuery(a)).removeClass(a.asStripClasses.join(" "));
            if (a.bJUI) {
        ...
        this.oApi._fnGetTrNodes = jQuery;
...
jQuery.fn.sliderNav = function (b) {
    var f = {
    ...
    var e = jQuery.extend(f, b);
    var g = jQuery.meta ? jQuery.extend({}, e, jQueryjQuery.data()) : e;
    var d = jQuery(this);
    jQuery(d).addClass("slider");
    jQuery(".slider-content li:first", d).addClass("selected");
    jQuery(d).append('<div class="slider-nav"><ul></ul></div>');
    for (var c in g.items) {
        jQuery(".slider-nav ul", d).append("<li><a alt='#" + g.items[c] + "'>" + g.items[c] + "</a></li>")
    }
    var a = jQuery(".slider-nav", d).height();
    if (g.height) {
        a = g.height
    }
    jQuery(".slider-content, .slider-nav", d).css("height", a);
    if (g.debug) {
        jQuery(d).append('<div id="debug">Scroll Offset: <span>0</span></div>')
    }
    jQuery(".slider-nav a", d).mouseover(function (k) {
        var m = jQuery(this).attr("alt");
        var i = jQuery(".slider-content", d).offset().top;
        var j = jQuery(".slider-content " + m, d).offset().top;
        var h = jQuery(".slider-nav", d).height();
        if (g.height) {
            h = g.height
        }
        var l = (j - i) - h / 8;
        jQuery(".slider-content li", d).removeClass("selected");
        jQuery(m).addClass("selected");
        jQuery(".slider-content", d).stop().animate({
            scrollTop: "+=" + l + "px"
        });
        if (g.debug) {
            jQuery("#debug span", d).html(j)
        }
    });
    if (g.arrows) {
        jQuery(".slider-nav", d).css("top", "20px");
        jQuery(d).prepend('<div class="slide-up end"><span class="arrow up"></span></div>');
        jQuery(d).append('<div class="slide-down"><span class="arrow down"></span></div>');
        jQuery(".slide-down", d).click(function () {
            jQuery(".slider-content", d).animate({
                scrollTop: "+=" + a + "px"
            }, 500)
        });
        jQuery(".slide-up", d).click(function () {
            jQuery(".slider-content", d).animate({
                scrollTop: "-=" + a + "px"
            }, 500)
        })
...
jQuery.fn.sliderNav = function (options) {
    ...
    jQuery('.slider-nav a', slider).mouseover(function (event) {
        ...
        jQuery('.slider-content', slider).stop().animate({
            scrollTop: '+=' + pScroll + 'px'
        });
        if (o.debug) jQuery('#debug span', slider).html(tOffset);
    });
    if (o.arrows) {
        jQuery('.slider-nav', slider).css('top', '20px');
        ...
        jQuery('.slide-down', slider).click(function () {
            jQuery('.slider-content', slider).animate({
                scrollTop: "+=" + height + "px"
            }, 500);
        });
...
(function (c) {
    ...
    function b(e, d) {
        this.jQueryelement = c(e);
        this.options = d;
        this.enabled = true;
        a(this.jQueryelement)
    }
    b.prototype = {
        show: function () {
            var g = this.getTitle();
            if (g && this.enabled) {
                ...
                var j = c.extend({}, this.jQueryelement.offset(), {
                    width: this.jQueryelement[0].offsetWidth,
                    height: this.jQueryelement[0].offsetHeight
                });
                var d = f[0].offsetWidth,
                    i = f[0].offsetHeight;
                var h = (typeof this.options.gravity == "function") ? this.options.gravity.call(this.jQueryelement[0]) : this.options.gravity;
                var e;
                switch (h.charAt(0)) {
                case "n":
                    e = {
        ...
        getTitle: function () {
            ...
            f = ("" + f).replace(/(^\s*|\s*jQuery)/, "");
            return f || e.fallback
        },
        tip: function () {
            if (!this.jQuerytip) {
                this.jQuerytip = c('<div class="tipsy"></div>').html('<div class="tipsy-arrow"></div><div class="tipsy-inner"/></div>')
            }
...
(function (a) {
    ...
    a.fn.uniform = function (k) {
        ...
        function j(l) {
            jQueryel = a(l);
            jQueryel.addClass(jQueryel.attr("type"));
            b(l)
        }
        function g(l) {
...
(function (a) {
    ...
    a.extend(a.validator, {
        ...
        prototype: {
            ...
            formatAndAdd: function (c, e) {
                ...
                if (typeof d == "function") {
                    ...
                    if (b.test(d)) {
                        d = jQuery.format(d.replace(b, "{jQuery1}"), e.parameters)
                    }
                }
                this.errorList.push({
                    message: d,
        ...
        methods: {
            ...
            email: function (c, b) {
                return this.optional(b) || /^((([a-z]|\d|[!#\jQuery%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\jQuery%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?jQuery/i.test(c)
            },
            url: function (c, b) {
                return this.optional(b) || /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)|\/|\?)*)?jQuery/i.test(c)
            },
            date: function (c, b) {
                return this.optional(b) || !/Invalid|NaN/.test(new Date(c))
            },
            dateISO: function (c, b) {
                return this.optional(b) || /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}jQuery/.test(c)
            },
            number: function (c, b) {
                return this.optional(b) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?jQuery/.test(c)
            },
            digits: function (c, b) {
                return this.optional(b) || /^\d+jQuery/.test(c)
            },
            ...
            accept: function (c, b, d) {
                ...
                return this.optional(b) || c.match(new RegExp(".(" + d + ")jQuery", "i"))
            },
    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            formatAndAdd: function (a, b) {
                ...
                else if (e.test(d)) d = jQuery.format(d.replace(e, "{jQuery1}"), b.parameters);
                this.errorList.push({
                    message: d,
                    element: a
                });
        ...
        methods: {
            ...
            accept: function (a, b, d) {
                d = typeof d == "string" ? d.replace(/,/g, "|") : "png|jpe?g|gif";
                return this.optional(b) || a.match(RegExp(".(" + d + ")jQuery", "i"))
            },
...
jQuery.fn.initMenu = function () {
    return this.each(function () {
        ...
        jQuery("li:has(ul)", this).each(function () {
            jQuery(">a", this).append("<span class='arrow'></span>")
        });
        jQuery(".sub", this).hide();
        jQuery("li.expand > .sub", this).show();
        jQuery("li.expand > .sub", this).prev().addClass("active");
        jQuery("li a", this).click(function (d) {
            d.stopImmediatePropagation();
            var c = jQuery(this).next();
            var b = this.parentNode.parentNode;
            if (jQuery(this).hasClass("active-icon")) {
                jQuery(this).addClass("non-active-icon");
                jQuery(this).removeClass("active-icon")
            } else {
                jQuery(this).addClass("active-icon");
                jQuery(this).removeClass("non-active-icon")
            }
            if (jQuery(b).hasClass("noaccordion")) {
                if (c[0] === undefined) {
                    window.location.href = this.href
                }
                jQuery(c).slideToggle("normal", function () {
                    if (jQuery(this).is(":visible")) {
                        jQuery(this).prev().addClass("active")
                    } else {
                        jQuery(this).prev().removeClass("active");
                        jQuery(this).prev().removeClass("active-icon")
                    }
                });
                return false
            } else {
                if (c.hasClass("sub") && c.is(":visible")) {
                    if (jQuery(b).hasClass("collapsible")) {
                        jQuery(".sub:visible", b).first().slideUp("normal", function () {
                            jQuery(this).prev().removeClass("active");
                            jQuery(this).prev().removeClass("active-icon")
                        });
                        return false
...
jQuery(document).ready(function () {
    ...
    jQuery(".menu li a").slideList();
    jQuery("a[href*=#]").bind("click", function (b) {
        b.preventDefault();
        var c = jQuery(this).attr("href");
        if (c == "#top") {
            jQuery.jGrowl("Scrolling to the top.", {
                theme: "information"
            })
        }
    ...
    jQuery(".toolbox-action").click(function () {
        jQuery(".toolbox-content").fadeOut();
        jQuery(this).next().fadeIn();
        return false
    });
    jQuery(".close-toolbox").click(function () {
        jQuery(this).parents(".toolbox-content").fadeOut()
    });
    jQuery(".user-button").click(function () {
        jQuery(".dropdown-username-menu").slideToggle()
    });
    jQuery(document).click(function (b) {
        if (!jQuery(b.target).is(".user-button, .arrow-link-down, .dropdown-username-menu *")) {
            jQuery(".dropdown-username-menu").slideUp()
        }
    });
    var a;
    jQuery(".user-button, ul.dropdown-username-menu").mouseleave(function (b) {
        a = setTimeout(function () {
            jQuery(".dropdown-username-menu").slideUp()
        }, 400)
    });
    jQuery(".user-button, ul.dropdown-username-menu").mouseenter(function (b) {
        clearTimeout(a)
    });
    jQuery(".block-border .block-header span").click(function () {
        if (jQuery(this).hasClass("closed")) {
            jQuery(this).removeClass("closed")
        } else {
            jQuery(this).addClass("closed")
        }
        jQuery(this).parent().parent().children(".block-content").slideToggle()
    });
    jQuery("a[rel=tooltip]").tipsy({
        fade: true
    });
    jQuery("a[rel=tooltip-bottom]").tipsy({
        fade: true
    });
    jQuery("a[rel=tooltip-right]").tipsy({
        fade: true,
        gravity: "w"
    });
    jQuery("a[rel=tooltip-top]").tipsy({
        fade: true,
        gravity: "s"
    });
    jQuery("a[rel=tooltip-left]").tipsy({
        fade: true,
        gravity: "e"
    });
    jQuery("a[rel=tooltip-html]").tipsy({
        fade: true,
        html: true
    });
    jQuery("div[rel=tooltip]").tipsy({
        fade: true
    })
});
...
jQuery().ready(function () {
    jQuery.validator.setDefaults({
        submitHandler: function (e) {
            jQuery.jGrowl("Form was successfully submitted.", {
                theme: 'success'
            });
    ...
    var v = jQuery("#create-user-form").validate();
    jQuery("#reset").click(function () {
        v.resetForm();
        jQuery.jGrowl("User was not created!", {
            theme: 'error'
        });
    });
    var v2 = jQuery("#write-message-form").validate();
    jQuery("#reset2").click(function () {
        v2.resetForm();
        jQuery.jGrowl("Message was not sent.", {
            theme: 'error'
        });
    });
    var v3 = jQuery("#create-folder-form").validate();
    jQuery("#reset3").click(function () {
        v3.resetForm();
        jQuery.jGrowl("Folder was not created!", {
            theme: 'error'
        });
    });
    var validateform = jQuery("#validate-form").validate();
    jQuery("#reset-validate-form").click(function () {
        validateform.resetForm();
        jQuery.jGrowl("Blogpost was not created.", {
            theme: 'error'
        });
    });
    var validatelogin = jQuery("#login-form").validate({
        invalidHandler: function (form, validator) {
            var errors = validator.numberOfInvalids();
            if (errors) {
                var message = errors == 1 ? 'You missed 1 field. It has been highlighted.' : 'You missed ' + errors + ' fields. They have been highlighted.';
                jQuery('#login-form').removeAlertBoxes();
                jQuery('#login-form').alertBox(message, {
                    type: 'error'
                });
    ...
    jQuery("#specify-a-unique-tab-name").createTabs();
    jQuery("#tab-graph").createTabs();
    jQuery("#tab-panel-1").createTabs();
    jQuery("#tab-panel-2").createTabs();
    jQuery('#slider').sliderNav();
    jQuery('#notification-success').click(function () {
        jQuery.jGrowl("Hey, I'm a <strong>success</strong> message. :-)<br>I want to say you something...", {
            theme: 'success'
        });
    });
    jQuery('#notification-error').click(function () {
        jQuery.jGrowl("Hey, I'm a <strong>error</strong> message. :-)<br>I want to say you something...", {
            theme: 'error'
        });
    });
    jQuery('#notification-information').click(function () {
        jQuery.jGrowl("Hey, I'm a <strong>information</strong> message. :-)<br>I want to say you something...", {
            theme: 'information'
        });
    });
    jQuery('#notification-warning').click(function () {
        jQuery.jGrowl("Hey, I'm a <strong>warning</strong> message. :-)<br>I want to say you something...", {
            theme: 'warning'
        });
    });
    jQuery('#notification-saved').click(function () {
        jQuery.jGrowl("Hey, I'm a <strong>saved</strong> message. :-)<br>I want to say you something...", {
            theme: 'saved'
        });
    });
    jQuery("select, input:checkbox, input:text, input:password, input:radio, input:file, textarea").uniform();
});